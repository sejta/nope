...
## v1.6.4 — 2026-02-23
- docs: исправлен и синхронизирован порядок middleware-обёрток в `MIDDLEWARE.md`
- docs: добавлено явное пояснение про порядок `h = middlewareX(h)` в `README.md`
- docs: исправлен пример `Timeout` + `TimeoutError` в `README.md`
